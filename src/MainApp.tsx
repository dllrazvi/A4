...
function MainApp() {
    ...
    useEffect(() => {
        const fetchDrivers = async () => {
            try {
                const response = await axios.get<F1Driver[]>(`https://a4-q8zo.onrender.com//api/f1drivers`);
    ...
    useEffect(() => {
        const fetchDriverHistory = async () => {
            try {
                const response = await axios.get<DriverRaceHistory[]>(`https://a4-q8zo.onrender.com//api/driverracehistory`);
    ...
    const handleAddDriver = async () => {
        try {
            const updatedDriversResponse = await axios.get<F1Driver[]>('https://a4-q8zo.onrender.com//api/f1drivers');
    ...
    const handleAddDriverRaceHistory = async () => {
        try {
            const updatedDriverHistoryResponse = await axios.get<DriverRaceHistory[]>('https://a4-q8zo.onrender.com//api/driverracehistory');
